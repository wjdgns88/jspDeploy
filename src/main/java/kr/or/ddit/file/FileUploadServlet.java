...
public class FileUploadServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//파일의 경우 rqeuest.getPart를 통해서 얻을 수 있다.
		...
		//form-data; name="uploadFile"; filename="james.png"
		String contentDisposition = uploadFilePart.getHeader("Content-Disposition");
		logger.debug("contentDispostion : " + contentDisposition);
		...
		//파일 저장 경로 설정
		//실무 : 별도 storage
		//개발환경 : 임의 영역 (서버 변경시, 재기동시 업로드 파일 삭제)
